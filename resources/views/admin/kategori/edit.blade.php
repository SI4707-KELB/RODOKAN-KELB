...
@section('title', 'Edit Kategori Laporan - RODOKAN')
...
<div class="kategori-container">
    <div style="margin-bottom: 24px;">
        <h2 style="font-size:24px; font-weight:700;">Edit Kategori</h2>
        <p style="color:#64748b; font-size:14px; margin-top:4px;">Ubah informasi kategori pelaporan.</p>
    </div>
